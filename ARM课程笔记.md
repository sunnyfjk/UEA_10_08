...
graph TD
subgraph STM32
初始化设备-->启动FREErtos任务调度
启动FREErtos任务调度-->创建分析任务
创建分析任务-->使能串口DMA接收
使能串口DMA接收-->分析上位的指令
分析上位的指令-->操作风扇开关
分析上位的指令-->操作热水器开关
分析上位的指令-->操作电灯开关
分析上位的指令-->其他操作
操作风扇开关-->通过串口DMA发送指令执行结果
操作热水器开关-->通过串口DMA发送指令执行结果
操作电灯开关-->通过串口DMA发送指令执行结果
其他操作-->通过串口DMA发送指令执行结果
启动FREErtos任务调度-->创建数据收集任务
创建数据收集任务-->读取温度数据
创建数据收集任务-->读取湿度数据
创建数据收集任务-->读取PM2.5数据
创建数据收集任务-->读取光线强度数据
